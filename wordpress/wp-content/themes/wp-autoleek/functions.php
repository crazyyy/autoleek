...
if (function_exists('add_theme_support')) {
  ...
  add_image_size('slider', 750, 370, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
if (function_exists('register_sidebar')) {
  ...
  register_sidebar(array(
    ...
    'id' => 'widgetarea1',
    'before_widget' => '<div id="%1$s" class="widget %2$s disable-click">',
    'after_widget' => '</div>',
    'before_title' => '<h6>',
    'after_title' => '</h6>'
  ));
